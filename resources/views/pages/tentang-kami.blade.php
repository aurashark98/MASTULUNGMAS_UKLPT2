            ...
            <div class="grid lg:grid-cols-2 gap-20 items-center">
                <div x-data="{ shown: false }" x-init="setTimeout(() => shown = true, 100)">
                    ...
                    <p x-show="shown" x-transition:enter="transition ease-out duration-1000 delay-400 fade-up" 
                       class="text-xl text-gray-500 dark:text-gray-400 mb-10 leading-relaxed font-medium">
                    ...
                    <div x-show="shown" x-transition:enter="transition ease-out duration-1000 delay-600 fade-up" class="grid grid-cols-2 gap-8">
                        <div>
                            ...
                            <p class="text-gray-400 font-bold uppercase text-xs tracking-widest">Didirikan</p>
                        </div>
                        <div>
                            <h4 class="text-3xl font-black text-mtm-red mb-2">100%</h4>
                            <p class="text-gray-400 font-bold uppercase text-xs tracking-widest">Karya Anak Bangsa</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-24 relative overflow-hidden">
        <div class="container mx-auto px-4">
            <div class="text-center max-w-3xl mx-auto mb-20">
                ...
                <p class="text-gray-500 font-medium">Budaya kerja dan komitmen kami kepada seluruh pengguna dan mitra.</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
                <div class="glass-card p-12 rounded-[3rem] text-center group hover:bg-mtm-red transition-all duration-500">
                    ...
                    <p class="text-gray-500 group-hover:text-white/80 transition-colors">Kejujuran dan transparansi adalah pondasi dari setiap transaksi di platform kami.</p>
                </div>
                <div class="glass-card p-12 rounded-[3rem] text-center group hover:bg-mtm-red transition-all duration-500">
                    <div class="w-16 h-16 bg-mtm-red/10 rounded-2xl flex items-center justify-center text-mtm-red mx-auto mb-8 group-hover:bg-white group-hover:text-mtm-red transition-all">
                    ...
                    <p class="text-gray-500 group-hover:text-white/80 transition-colors">Kami memahami kebutuhan Anda dan berusaha memberikan solusi yang paling manusiawi.</p>
                </div>
                <div class="glass-card p-12 rounded-[3rem] text-center group hover:bg-mtm-red transition-all duration-500">
                    <div class="w-16 h-16 bg-mtm-red/10 rounded-2xl flex items-center justify-center text-mtm-red mx-auto mb-8 group-hover:bg-white group-hover:text-mtm-red transition-all">
                    ...
                    <p class="text-gray-500 group-hover:text-white/80 transition-colors">Terus mengembangkan teknologi terbaik untuk menghubungkan kebaikan di seluruh pelosok negeri.</p>
                </div>
            </div>
        </div>
    </section>
