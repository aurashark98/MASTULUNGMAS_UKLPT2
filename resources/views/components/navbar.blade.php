    ...
    <div x-data="{ 
        ...
        <form x-show="activeTab === 'login'" method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="{{ route('auth.google') }}" class="flex items-center justify-center gap-2 py-2.5 border border-gray-100 dark:border-white/10 rounded-2xl hover:bg-gray-50 dark:hover:bg-white/5 transition-all group cursor-pointer">
                ...
                <button type="button" class="flex items-center justify-center gap-2 py-2.5 border border-gray-100 dark:border-white/10 rounded-2xl hover:bg-gray-50 dark:hover:bg-white/5 transition-all group cursor-pointer">
