<x-admin-layout>
    <div class="max-w-2xl mx-auto space-y-8 animate-fade-in">
        ...
        <div>
            ...
            <h2 class="text-3xl font-black font-poppins text-gray-800 dark:text-white">Tambah Penawaran Baru</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Buat penawaran harga tugas baru secara manual atas nama mitra.</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white dark:bg-mtm-dark-surface p-8 rounded-[2.5rem] border border-gray-200 dark:border-white/5 shadow-sm">
            <form method="POST" action="{{ route('admin.task-bids.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <x-text-input id="bid_amount" class="block w-full !py-3.5 bg-gray-50/50 dark:bg-[#121212]/30 border-gray-100 dark:border-white/5 rounded-2xl" type="number" name="bid_amount" :value="old('bid_amount')" required placeholder="Masukkan nominal penawaran" />
                ...
                <div class="space-y-2">
                    ...
                    <select id="status" name="status" required class="block w-full bg-gray-50/50 dark:bg-[#121212]/30 border-gray-200 dark:border-white/5 rounded-2xl focus:ring-mtm-red focus:border-mtm-red text-sm p-4 text-gray-700 dark:text-gray-300">
                        ...
                        <option value="accepted" {{ old('status') == 'accepted' ? 'selected' : '' }}>Accepted (Diterima)</option>
