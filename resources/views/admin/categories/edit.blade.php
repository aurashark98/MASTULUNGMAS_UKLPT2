<x-admin-layout>
    <div class="max-w-2xl mx-auto space-y-8 animate-fade-in">
        ...
        <div>
            ...
            <h2 class="text-3xl font-black font-poppins text-gray-800 dark:text-white">Ubah Kategori Jasa</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Edit detail bidang layanan jasa: {{ $category->name }}.</p>
        </div>
        ...
        <div class="bg-white dark:bg-mtm-dark-surface p-8 rounded-[2.5rem] border border-gray-200 dark:border-white/5 shadow-sm">
            <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <x-text-input id="name" class="block w-full !py-3.5 bg-gray-50/50 dark:bg-[#121212]/30 border-gray-100 dark:border-white/5 rounded-2xl" type="text" name="name" :value="old('name', $category->name)" required autofocus placeholder="Contoh: Kelistrikan, Kebersihan" />
                ...
                <div class="space-y-2">
                    ...
                    <x-text-input id="icon" class="block w-full !py-3.5 bg-gray-50/50 dark:bg-[#121212]/30 border-gray-100 dark:border-white/5 rounded-2xl" type="text" name="icon" :value="old('icon', $category->icon)" placeholder="Contoh: Zap, Sparkles, Clock, Truck" />
