        ...
        <nav class="flex-1 px-4 py-4 space-y-4 overflow-y-auto text-xs">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.disputes.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-bold transition-all {{ request()->routeIs('admin.disputes.*') ? 'bg-mtm-red/10 text-mtm-red font-extrabold' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-950 dark:hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
